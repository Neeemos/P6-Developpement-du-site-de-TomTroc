...
<img src="images/darwin-vegher.jpg" alt="" class="information__banner">

<section class="values">
    <div class="values__content">
        <h2 class="values__title">Nos valeurs</h2>
        <p class="values__text">Chez Tom Troc, nous mettons l'accent sur le partage, la découverte et la communauté. Nos
            valeurs sont ancrées dans notre passion pour les livres et notre désir de créer des liens entre les
            lecteurs. Nous croyons en la puissance des histoires pour rassembler les gens et inspirer des conversations
            enrichissantes.</p>
        <p class="values__text">Notre association a été fondée avec une conviction profonde : chaque livre mérite d'être
            lu et partagé.</p>
        <p class="values__text">Nous sommes passionnés par la création d'une plateforme conviviale qui permet aux
            lecteurs de se connecter, de partager leurs découvertes littéraires et d'échanger des livres qui attendent
            patiemment sur les étagères.</p>
        <div class="values__heart heart">
            <div class="heart__content">L’équipe Tom Troc</div>
            <img class="heart__img" src="images/coeur.svg" alt="coeur vert">
        </div>
    </div>
</section>